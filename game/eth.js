...
var tokenAbi = [
  ...
  var token = new web3.eth.Contract(tokenAbi, "0x74404451949591AD3c9e5Dbb828cfe31EA8a867a");
  var marketplace = new web3.eth.Contract(marketplaceAbi, "0x91FDE501C196A29025Bc3b732a1e0De70a63a4A3");
    ...
    web3.eth.getAccounts().then(accountArray => {
      ...
      Promise.all([tokenPromise1, tokenPromise2, tokenPromise3])
        .then(values => {
          ...
          var numberOfBoots = values[0];
          var numberOfTalismans = values[1];
          var numberOfCapes = values[2];

          if(numberOfBoots > 0) 
            PLAYER_SPEED = PLAYER_SPEED * Math.pow(0.75, numberOfBoots)
